...
const T = {
  fr: {
    ...
    statLabels: ["Villageois", "Espaces de réunion, de formation et de coworking", "Événements annuels", "d'espaces", "Studios audio & podcast", "Sites"],
  ...
  en: {
    ...
    statLabels: ["Villagers", "Meeting, training & coworking spaces", "Annual events", "of space", "Audio & podcast studios", "Sites"],
  ...
  ar: {
    ...
    statLabels: ["سكان القرية", "فضاءات اجتماعات وتكوين وعمل مشترك", "فعاليات سنوية", "من المساحات", "استوديوهات صوت وبودكاست", "مواقع"],
