  ...
  return (
    <section className="border-t border-black/5 bg-white py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <h2 className="text-2xl font-bold text-navy-950">Nous trouver</h2>

        <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-black/10 p-6">
            <p className="font-bold text-navy-950">Startup Village Menzah</p>
          ...
          <div className="rounded-2xl border border-black/10 p-6">
            <p className="font-bold text-navy-950">Startup Village Charguia</p>
            <p className="mt-1 text-sm text-navy-950/70">
              Adresse disponible sur{" "}
              <a
        ...
        <div className="mt-6 overflow-hidden rounded-2xl border border-black/10">
          <iframe
            title="Localisation Startup Village Menzah"
