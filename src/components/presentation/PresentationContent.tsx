...
const T = {
  ...
  ar: {
    ...
    pillars: [
      { h: "الابتكار والإبداع المشترك", p: "تشجيع تبادل الأفكار والتعاون العابر للتخصّصات والمنهجيات الرشيقة." },
      { h: "جودة الحياة والرفاهية", p: "توفير إطار مرحّب يعزّز التركيز والاسترخاء والنموّ الشخصي." },
      { h: "الانفتاح والشمول", p: "الترحيب بتنوّع الملامح والقطاعات والمواهب لإثراء المجتمع." },
    ],
