...
const ARTICLES: Article[] = [
  ...
  { date: { fr: "02 May 2025", en: "02 May 2025", ar: "02 مايو 2025" }, title: { fr: "Imed Zitouni Google : Intelligence artificielle, innovation et talents tunisiens", en: "Imed Zitouni, Google: Artificial intelligence, innovation and Tunisian talent", ar: "عماد زيتوني من Google: الذكاء الاصطناعي والابتكار والمواهب التونسية" }, cat: "tech", img: `${IMG}imed-zitouni.png`, link: "/actualites/imed-zitouni" },
