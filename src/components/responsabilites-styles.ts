...
.responsabilites-page .engagement-card:hover { transform:translateY(-4px); box-shadow:0 6px 16px rgba(15,39,72,0.06); border-color:rgba(15,39,72,0.12); }
...
.responsabilites-page .realisation__media { border-radius:var(--radius); overflow:hidden; box-shadow:0 4px 16px rgba(15,39,72,0.08); }
