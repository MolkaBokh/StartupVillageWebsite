...
// Responsabilités page assets, imported locally from the source repository.
...
export default function ResponsabilitesPage() {
  return (
    <div className="responsabilites-page">
      <style>{STYLES}</style>
      ...
      <main>
        ...
        <section className="hero">
          <div className="container">
            <p className="hero__label">Responsabilités</p>
            <h1 className="hero__title">
              Une Démarche Écoresponsable<br className="br-desktop" /> au Cœur du Village
            </h1>
            <p className="hero__text">
              Le village met en place une démarche écoresponsable. Chaque villageois adopte
              des gestes du quotidien pour réduire son impact environnemental. Ceci implique
              davantage le village dans la responsabilité sociétale des entreprises&nbsp;(RSE).
            </p>
            <ul className="hero__badges">
              <li className="badge badge--blue">Innovation</li>
              <li className="badge badge--pink">Créativité</li>
              <li className="badge badge--green">Durabilité</li>
            </ul>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="engagements__grid">
              <article className="engagement-card">
                <span className="engagement-card__bar engagement-card__bar--blue"></span>
                <h3 className="engagement-card__title">Économie circulaire</h3>
                <p className="engagement-card__text">
                  Nous favorisons la réutilisation des matériaux et la transformation
                  créative des ressources existantes.
                </p>
              </article>

              <article className="engagement-card">
                <span className="engagement-card__bar engagement-card__bar--pink"></span>
                <h3 className="engagement-card__title">Art responsable</h3>
                <p className="engagement-card__text">
                  De nombreuses œuvres présentes dans le Village sont conçues à partir
                  d&apos;objets récupérés et détournés.
                </p>
              </article>

              <article className="engagement-card">
                <span className="engagement-card__bar engagement-card__bar--green"></span>
                <h3 className="engagement-card__title">Communauté engagée</h3>
                <p className="engagement-card__text">
                  Villageois, partenaires et visiteurs contribuent à une culture
                  d&apos;innovation plus consciente et durable.
                </p>
              </article>
            </div>
          </div>
        ...
        <section className="realisations">
          <div className="container">
            {/* Bloc 1 : photo gauche / texte droite */}
            <article className="realisation">
              <div className="realisation__media">
                <img
                  src={`${IMG}1.png`}
                  alt="Œuvre d'art réalisée à partir de matériaux récupérés au Village"
                  loading="lazy"
                />
              </div>
              <div className="realisation__body">
                <span className="realisation__index">01</span>
                <h3 className="realisation__title">{"L'art au service de l'écoresponsabilité"}</h3>
                <p className="realisation__text">
                  {"Au Village, l'art raconte une autre histoire de la matière. Les œuvres naissent d'objets récupérés et détournés, transformés en créations singulières. Chaque pièce rappelle qu'un déchet peut devenir beauté et que la créativité est un puissant levier écologique."}
                </p>
              </div>
            </article>

            {/* Bloc 2 : texte gauche / photo droite */}
            <article className="realisation realisation--reverse">
              <div className="realisation__media">
                <img
                  src={`${IMG}2.jpg`}
                  alt="Atelier de création et d'innovation autour de l'économie circulaire"
                  loading="lazy"
                />
              </div>
              <div className="realisation__body">
                <span className="realisation__index">02</span>
                <h3 className="realisation__title">{"Création et innovation au service de l'économie circulaire"}</h3>
                <p className="realisation__text">
                  {"L'innovation guide notre manière de produire et de consommer. Dans les ateliers du Village, ressources et savoir-faire se réinventent pour prolonger la vie des matériaux. Une approche concrète où l'économie circulaire devient un moteur de progrès partagé."}
                </p>
              </div>
            </article>
          </div>
        ...
        {/* SECTION 4 — PHOTO MANIFESTE */}
        <section className="manifeste" aria-label="Notre manifeste">
          <div className="manifeste__overlay"></div>
          <p className="manifeste__quote">
            Chaque détail du Village reflète notre volonté de créer autrement.
          </p>
        </section>
